...
export default function ImposterGameCategoriesPage() {
  return <div className="content-page">
    ...
    <main>
      ...
      <section className="example-section" aria-labelledby="themed-packs-heading"><div><span className="eyebrow">THEMED PACKS</span><h2 id="themed-packs-heading">Halloween, football, K-pop, pop, Christmas and brainrot</h2><p>Six free themed packs, with 48–80 words each and their own pages: <Link href="/packs/halloween/">Halloween</Link>, <Link href="/packs/football/">football</Link>, <Link href="/packs/k-pop/">K-pop</Link>, <Link href="/packs/pop-superstars/">pop superstars</Link>, <Link href="/packs/christmas/">Christmas</Link> and <Link href="/packs/brainrot/">brainrot</Link>. Browse them all on the <Link href="/packs/">packs page</Link>.</p></div><ul className="variant-list"><li><strong>Seasonal.</strong> Halloween and Christmas words for the parties that actually happen.</li><li><strong>Fandom.</strong> Football, K-pop and pop hits: the friends who know the most get suspected the most.</li><li><strong>Internet.</strong> Brainrot slang, 6-7 included: the teenagers know every word and the adults are the suspects.</li></ul></section>
    </main>
  </div>;
}
