...
export default function TimerImposterPage() {
  return <VariantPage
    ...
    steps={[
      { title: 'Add 3–5 free players and pick a range.', text: 'Short (3–15 s) is the classic. Quick is savage, Long is a test of nerve, and Flash (0.5–1.5 s) is the sub-second range from the 0.96 video.' },
    ...
    faqs={[
      ...
      { q: 'What is the 0.96 timer imposter video?', a: 'The clip people search for is Big Potato Club’s August 2026 TikTok: three friends in the back of a car, a stopwatch on an iPad, a target of 0.96 seconds — and the imposter, who never saw the number, stopping the clock on exactly 0.96. The comments argue about whether it was staged. Either way, it is why sub-second targets are now part of the game.' },
      { q: 'How do you play the 0.96 challenge?', a: 'Same rules, tiny target. Pick the Flash range and the target lands somewhere between 0.50 and 1.50 seconds. Nobody can count that fast, so it comes down to reflex and nerve — and hitting it exactly, like the video, is pure luck. A caught imposter still gets a final guess, within 0.30 s. Land within 0.05 s and the reveal calls it a perfect run.', cta: { href: '/timer-imposter/?range=flash#timer-imposter', label: 'Play the 0.96 version' } },
