...
export const siteTitleSuffix = ' | LaughTable';
...
export function pageMetadata(path: string, title: string, description: string): Metadata {
  ...
  return {
    ...
    openGraph: { title, description, url, type: 'website', images: [{ url: image, width: 1200, height: 630, type: 'image/png', alt: ogImageAlt }] },
