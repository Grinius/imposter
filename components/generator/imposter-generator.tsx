...
export default function ImposterGenerator() {
  ...
  function generate() {
    ...
    if (trimmed.length < 3 || trimmed.length > freePlayerLimit) { setError('Use 3-12 players for the free imposter game. Premium larger rooms are locked until payment is connected.'); return; }
  ...
  return <section className="generator-tool" aria-labelledby="generator-tool-title">
    <div className="generator-controls">
      <div className="generator-panel">
        ...
        <p>Create a secret word, assign one imposter, and reveal private role cards for 3-12 free players.</p>
