...
export default function Game() {
  ...
  return <>
    ...
    <footer className="site-footer"><span className="footer-brand"><Eye size={18} strokeWidth={1.3} /> {siteName}<small>{siteHost}</small></span><span>A little mystery brings people together.</span><span>Made for a good night in <Heart size={12} /></span><Link href="/privacy/">Privacy</Link></footer>
