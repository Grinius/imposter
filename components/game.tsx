...
import { freePlayerLimit, premiumFeatures } from '@/lib/premium';
    ...
    <main id="game">
      {isSetup ? <div className="setup-layout">
        <section className="intro">
          ...
          <div className="intro-facts"><span><Users size={16} /> 3–12 free players</span><span><Clock3 size={16} /> 5-minute rounds</span><span><Smartphone size={16} /> Just one phone</span></div>
        </section>
