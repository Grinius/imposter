...
const room: PublicRoom = { roomId: 'ABC123', hostId: 'host', status: 'lobby', round: 0, premium: false, players: [{ id: 'host', name: 'Alex', connected: true, isHost: true }, { id: 'guest', name: 'Jamie', connected: true, isHost: false }] };
