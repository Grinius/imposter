...
Do not read from or write to the owner's Apple Notes (or other personal apps) via AppleScript or
automation. The checkpoint list lives in `docs/CHECKPOINTS.md`; that file is the shared copy.
